...
public class Program
{
    ...
    /**
     *
     * @param pShow added show
     * @param pDay day of the show
     * @pre pShow != null and pDay != null
     */
    public void resetAndAdd(Show pShow, Day pDay) {
        assert pShow != null && pDay != null;
        CompositeCommand commands = new CompositeCommand(() -> Arrays.fill(aShows, NullShow.DEFAULT), () -> aShows[pDay.ordinal()] = pShow.clone());
        aCommands.add(commands);
        commands.execute();
    }

    public void addWithLog(Show pShow, Day pDay) {
        assert pShow != null && pDay != null;
        LoggedCommand command = new LoggedCommand(() -> aShows[pDay.ordinal()] = pShow.clone(), "Added new show");
        aCommands.add(command);
        command.execute();
    }
}